	...
	<div class="controls">
		<select name="subsubcategory_id" class="form-control" required="" >
            ...
            @foreach ($subsubcategories as $subsubcategory )
                <option value="{{$subsubcategory->id}}" {{$subsubcategory->id == $products->subsubcategory_id ? 'selected': ''}} >{{ $subcategory->subcategory_name_en }}</option>
            @endforeach
		</select>
...
<div class="row"> <!-- start 7th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	<textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Textarea text" value="">{{$products->short_descp_en}}</textarea>     
	 		 </div>
		</div>
	     ...
	     <div class="form-group">
			...
			<div class="controls">
	<textarea name="short_descp_hin" id="textarea" class="form-control" required placeholder="Textarea text" value="">{{$products->short_descp_hin}}</textarea>     
	 		 </div>
		</div>
...
<input type="submit" class="btn btn-rounded btn-primary mb-5" value="Update Product">
        ...
        </section><!-- End Multi image Update -->


        <!-- ///////// Start Product Thumbnail Image Update area /////-->
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box bt-3 border-info">
                      <div class="box-header">
                        <h4 class="box-title">Product Thumbnail Image Update</strong></h4>
                      </div>
                      <form method="post" action="{{ route('update-product-thambnail') }}" enctype="multipart/form-data" >
                        ...
                        <div class="row row-sm">
                                ...
                                <div class="col-md-3">
                                    |<div class="card">
                                        <img src="{{ asset($products->product_thambnail) }}" class="card-img-top" style="height: 130px; width:280px;" alt="...">
                                        <div class="card-body">
        ...
        </section><!-- End Product Thumbnail image Update -->
	  </div>
