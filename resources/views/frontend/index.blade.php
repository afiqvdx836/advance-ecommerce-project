            ...
            <div class="item" style="background-image: url({{ asset($slider->slider_img) }});">
              <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
                  ...
                  <div class="excerpt fadeInDown-2 hidden-xs">{{ $slider->description }}</span> </div>
            ...
            <ul class="list-unstyled">
              <li class="add-cart-button btn-group">
                ...
                <button class="btn btn-primary cart-btn" type="button">Add to cart</button>
                  ...
                  <button  class="btn btn-primary icon" type="button" title="Wishlist" data-toggle="modal" data-target="#exampleModal" id="{{ $product->id }}" onclick="productView(this.id)"> <i class="fa fa-heart"></i> </button>
