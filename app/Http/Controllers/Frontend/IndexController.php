...
class IndexController extends Controller
{
    public function index(){
        ...
        $special_offer = Product::where('hot_deals', 1)->orderBy('id','DESC')->limit(3)->get();
    ...
    public function ProductDetails($id,$slug){
        ...
        return view('frontend.product.product_details', compact('product','multiImag','product_color_en','product_color_hin',
        'product_size_en','product_size_hin'));
    }

    public function TagWiseProduct($tag){
        $products = Product::where('status',1)->where('product_tags_en', $tag)->where('product_tags_hin', $tag)->orderBy('id','DESC')->paginate(2);
        $categories = Category::orderBy('category_name_en', 'ASC')->get();
        return view('frontend.common.tags_view', compact('products','categories'));
    }


    public function SubCatWiseProduct($subcat_id, $tag){
